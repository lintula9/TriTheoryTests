...
Another, more general, criterion for indistinguishability that the subspace of positive definite symmetric matrices $(\Sigma=\Lambda\Lambda^T+\Omega)\in\mathbb{R}^{K\times K}$ must be invariant under $A$.
